...
import {Box, Breadcrumbs, Card, CardActions, CardContent, Container, Divider, Grid, IconButton, Typography} from "@mui/material";
...
export const TechnologyPage = () => {
  ...
  return (
    <Box id="TechnologyPage" minHeight="80vh">
      <Container maxWidth={false}>
        <Grid container spacing={3}>
          <Grid item xs={0} md={3} lg={2} xl={2}>
            <CategoryMenu component="nav"/>
          </Grid>
          <Grid item xs={4} md={8} lg={8} xl={7}>
            <Card style={styles.card}>
              <CardContent>
                ...
                <Box className="article" p={1.5}>
                  <Typography variant="h4" align="center">想和你一起慢慢变老</Typography>
                  <Typography>一个人静静的凝望着晦暗的天空，阴霾弥漫的苍穹让人有了些许的落寞。</Typography>
